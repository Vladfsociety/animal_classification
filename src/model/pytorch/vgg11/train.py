...
def train():
	...
	save_metrics(
		history,
		num_epochs,
		"Training and Validation Accuracy (PyTorch VGG11 like model)",
		"reports/pytorch/vgg11/accuracy.jpg",
		"Training and Validation Loss (PyTorch VGG11 like model)",
		"reports/pytorch/vgg11/loss.jpg"
	)

	torch.save(model.state_dict(), 'models/pytorch/vgg11.pth')
