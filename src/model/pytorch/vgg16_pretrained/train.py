...
def train():
	...
	model = VGG16_pretrained(num_classes=num_classes).to(device)
	...
	save_metrics(
		history,
		num_epochs,
		"Training and Validation Accuracy (PyTorch VGG16 pretrained model)",
		"reports/pytorch/vgg16_pretrained/accuracy.jpg",
		"Training and Validation Loss (PyTorch VGG16 pretrained model)",
		"reports/pytorch/vgg16_pretrained/loss.jpg"
	)

	torch.save(model.state_dict(), 'models/pytorch/vgg16_pretrained.pth')
